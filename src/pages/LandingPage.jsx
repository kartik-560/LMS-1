...
const LandingPage = () => {
  ...
  <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
    ...
    <section className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Learn. Achieve. Shine.
            <span className="text-primary-600 block mt-2">With Pugarch</span>
          </h1>
      ...
      {/* Decorative Elements */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-primary-200 rounded-full opacity-20 blur-xl"></div>
      <div className="absolute top-40 right-20 w-32 h-32 bg-accent-200 rounded-full opacity-20 blur-xl"></div>
      <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-purple-200 rounded-full opacity-20 blur-xl"></div>
    </section>
